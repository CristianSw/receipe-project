...
@Component
public class RecipeToRecipeCommand implements Converter<Recipes, RecipeCommand> {
    ...
    @Nullable
    @Override
    public RecipeCommand convert(Recipes source) {
        if (source == null) {
            return null;
        }
        ...
        recipeCommand.setCockTime(source.getCockTime());
